...
class PlgUserProfile extends JPlugin
{
	...
	public function onContentPrepareForm($form, $data)
	{
		...
		$fields = array(
			'address1',
			'address2',
			'first-name', //Zusätzliches Feld
			'Organisation', //Zusätzliches Feld
			'mobile-number', //Zusätzliches Feld
			'city',
			'region',
			'country',
			'postal_code',
		...
		if ($app->isSite() || $name == 'com_users.user' || $name == 'com_admin.profile')
		{
			...
			$form->setFieldAttribute('address2', 'description', 'PLG_USER_PROFILE_FILL_FIELD_DESC_SITE', 'profile');
			$form->setFieldAttribute('Organisation', 'description', 'PLG_USER_PROFILE_FILL_FIELD_DESC_SITE', 'profile');
			$form->setFieldAttribute('mobile-number', 'description', 'PLG_USER_PROFILE_FILL_FIELD_DESC_SITE', 'profile');
