                    ...
                    <form 
                        ...
                        <!-- Start Name -->
                            <div class="input">
                                ...
                                <input 
                                    ...
                                    class="<?php echo (($myparams['displayName'] === 'R') ? 'required' : null) ?>" 
                        ...
                        <div class="input">
                            ...
                            <input 
                                ...
                                class="<?php echo (($myparams['displayEmail'] === 'R') ? 'required validate-email' : 'validate-email') ?>" 
                        ...
                        <!-- Start Subject -->
                            <div class="input">
                                ...
                                <input 
                                    ...
                                    class="<?php echo (($myparams['displaySubject'] === 'R') ? 'required' : null) ?>" 
                        ...
                        <?php if ($myparams['displayMessage'] == 'Y' || $myparams['displayMessage'] == 'R') : ?>
                            ...
                            <div class="input">
                                ...
                                <textarea 
                                    ...
                                    class="<?php echo (($myparams['displayMessage'] === 'R') ? 'required' : null) ?>"
                        ...
                        <div class="cw-mod-contact-<?php echo $myparams['theme']; ?>-buttons">
                            <div class="btn-submit">
                                <button 
                                    ...
                                    class="<?php echo $myparams['submitClass']; ?>"><?php echo $myparams['submitBtn']; ?>
                                </button>
                                <input 
                                    type="hidden" 
