...
$path = JPATH_BASE.DS.'components'.DS.'com_realestatemanager'.DS.'functions.php';
if (!file_exists($path)){
...
$doc->addStyleSheet(JURI::base(true).DS.'components'.DS.'com_realestatemanager'.DS.'includes'.DS.
'realestatemanager.css');
$menu = new JSite;
$menu->getMenu();
