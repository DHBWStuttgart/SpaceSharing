    ...
    <div class="ckpopupheader clearfix">
        ...
        <div id="showthemes" class="clearfix">
			...
			foreach ($files as $file) {
				...
				echo '<div class="themethumb" target="' . $theme . '"><img src="'. JUri::base(true) .'/components/com_templateck/themes/' . $theme . '.jpg" style="height:80px;width:80px;margin:0;padding:0;" onclick="if(!$ck(\'#ck_modelewrapper\').length) loadTheme(\'' . $theme . '\');"/><div class="themeindice">' . $i . '</div></div>';
				$i++;
			}
			echo '</div>';
			?>
