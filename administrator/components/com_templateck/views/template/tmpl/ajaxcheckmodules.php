...
echo '<p class="clearfix" style="border:1px solid #3399FF;margin: 10px 0;padding: 10px;"><img src="' . JUri::base(true) . '/components/com_templateck/images/logo_modulesmanagerck_64.png" style="display:inline-block;margin:0 5px;" align="left" />' . JText::_('CK_TRY_MODULES_MANAGER') . '</p>';