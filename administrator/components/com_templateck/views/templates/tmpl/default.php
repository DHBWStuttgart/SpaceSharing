...
<?php if (function_exists('get_magic_quotes_gpc') && get_magic_quotes_gpc()) { ?>
	<div class="alert alert-error">
		...
		<p>You must disable the 'magic_quotes_gpc' on your server else you will have some problems into Template Creator CK</p>
	</div>
<?php } ?>
    <table class="table table-striped" id="templateckList">
        ...
        <tbody>
			...
			foreach ($this->items as $i => $item) :
				...
				$link = 'index.php?option=com_templateck&view=template&task=template.edit&format=raw&id=' . $item->id;
				?>
