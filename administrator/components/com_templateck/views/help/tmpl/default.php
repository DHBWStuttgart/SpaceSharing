...
<div class="ckgrid">
    <h4 class="ckgridtitle"><?php echo JText::_('CK_HELP_VIDEO_FULLWIDTHWRAPPER') ?></h4>
    <iframe width="340" height="180" src="http://www.youtube.com/embed/2C-8-p4I19A" frameborder="0" allowfullscreen></iframe>
</div>
<div style="clear:both;"></div>
<h2><?php echo JText::_('CK_EXTRAVIDEO') ?></h2>
<div class="ckgrid">
    <h4 class="ckgridtitle"><?php echo JText::_('CK_HELP_VIDEO_MODULESMANAGER') ?></h4>
    <iframe width="340" height="180" src="https://www.youtube.com/embed/8BnlcUfKp0k" frameborder="0" allowfullscreen></iframe>
</div>
