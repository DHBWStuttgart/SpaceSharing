...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="adminForm" class="form-validate">
    <div>
        <fieldset class="adminform">
            <legend><?php echo JText::_('CK_INSTALL_FONT_GOOGLE'); ?></legend>
			<p class="alert alert-info"><?php echo JText::_('CK_INSTALL_FONT_GOOGLE_INSTRUCTIONS'); ?></p>
            <table class="admintable">
                <tr>
                    <td width="110" class="key">
                        <label for="title">
							<?php echo JText::_('CK_GOOGLEFONT_URL'); ?>:
                        </label>
                    </td>
                    <td>
