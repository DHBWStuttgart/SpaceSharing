...
abstract class TemplateCreatorck {
	...
	public static function banner($blockid, $positions) {
		...
		$html = "<div id=\"" . $blockid . "\" class=\"mainbanner ckbloc\">
            ...
            <div class=\"ckstyle\"></div>
            <div class=\"inner clearfix\">
                <div id=\"" . $blockid . "logo\" class=\"logobloc bannerlogo ckbloc\">
                    ...
                    <div class=\"tab_blocstyles ckprops\" blocbackgroundimageurl=\"" . JUri::base(true) . "/components/com_templateck/images/logo_fake.png\" blocwidth=\"30%\" logowidth=\"216\" logoheight=\"53\" fieldslist=\"blocbackgroundimageurl,blocwidth,logowidth,logoheight\"></div>
                    " . self::addJs($blockid . "logo") . "
                    <div class=\"ckstyle\">
                    <style type=\"text/css\" >#" . $blockid . "logo {width: 30%;}
					#" . $blockid . "logo > div.inner > .bannerlogodesc {
                    color: #a3a3a3;
                    text-align: center;
                    font-size: 13px;
                    ...
                    <div class=\"inner\">
                        <img src=\"" . JUri::base(true) . "/components/com_templateck/images/logo_fake.png\" width=\"216\" height=\"53\" />
                ...
                <div id=\"" . $blockid . "module\" class=\"logobloc banner ckbloc\" ckmoduleposition=\"" . $positions[0] . "\">
                    " . self::addJs($blockid . "module") . "
                    <div class=\"tab_blocstyles ckprops\" blocwidth=\"30%\" fieldslist=\"blocwidth\"></div>
                    <div class=\"ckstyle\"><style type=\"text/css\" >#" . $blockid . "module {width: 30%;}</style></div>
                    <div class=\"inner clearfix\">
                        <div class=\"moduletable\">
                            " . self::fillNews() . "
                        </div>
				...
				<div id=\"" . $blockid . "menu\" class=\"logobloc bannermenu ckbloc\" ckmoduleposition=\"" . $positions[1] . "\">
					" . self::addJs($blockid . "menu") . "
					<div class=\"tab_blocstyles ckprops\" blocwidth=\"40%\" fieldslist=\"blocwidth\"></div>
					" . self::addMenuCssProps($blockid . "menu") . "
					<div class=\"ckstyle\">
						<style type=\"text/css\" >#" . $blockid . "menu {width: 40%;}" . self::addMenuCssStyles($blockid . "menu") . "</style>
					</div>
					<div class=\"inner clearfix\">
					<div class=\"moduletable\">
						" . self::fillHorizmenu() . "
