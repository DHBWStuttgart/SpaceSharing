        ...
        <div class="basictable_15 basictable">
                <span>
                       ...
                       $user = JFactory::getUser(); 
                            echo sefRelToAbs($mosConfig_live_site . "/index.php?option="
                             . $option . "&amp;Itemid=" . $_REQUEST['Itemid']);                        
                            ?>'" value="OK">
        <?php
    }
              ...
              function() {
                ...
                var contentStr = '<div>'+
                      '<img width = "100%" src = "'+imgUrl+
                          '" onclick=window.open("index.php?option=com_realestatemanager'+
                          '&task=view&id=<?php echo $rows[$i]->id; ?>&catid=<?php echo $rows[$i]->idcat ?>'+
                  ...
                  '<div id="marker_link">'+
                      '<a onclick=window.open("index.php?option=com_realestatemanager&task=view'+
                          ...
                          '&Itemid=<?php echo $Itemid; ?>")>' + title + '</a>'+
                  '</div>'+
                  '<div id="marker_price">'+
                      '<a onclick=window.open("index.php?option=com_realestatemanager&task=view'+
                          '&id=<?php echo $rows[$i]->id; ?>&catid=<?php echo $rows[$i]->idcat ?>'+
