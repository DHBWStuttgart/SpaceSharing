...
if(!function_exists('protectInjection')){
    function protectInjection($value,$default = "",$filter = "STRING"){
        global $database;
        $value =  JFactory::getApplication()->input->get($value,$default,$filter);
...
if(!function_exists('protectInjectionWithoutQuote')){
    function protectInjectionWithoutQuote($value, $default = "",$filter = "STRING"){
        $value = JFactory::getApplication()->input->get($value, $default,$filter );
