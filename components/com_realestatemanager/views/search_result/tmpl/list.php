...
?>
        ...
        titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
         return false;" rel="nofollow"
           href="<?php echo $mosConfig_live_site; ?>/index.php?option=com_realestatemanager&amp;
           task=showCategory&amp;catid=<?php echo $catid; ?>&amp;Itemid=<?php echo $Itemid; ?>&amp;
           limitstart=<?php echo $limitstart; ?>&amp;printItem=pdf" title="PDF"  rel="nofollow">
...
?>
        ...
        titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
          return false;" rel="nofollow"
           href="<?php echo $mosConfig_live_site; ?>/index.php?option=com_realestatemanager&amp;
           task=showCategory&amp;catid=<?php echo $catid; ?>&amp;Itemid=<?php echo $Itemid; ?>&amp;
           limitstart=<?php echo $limitstart; ?>&amp;printItem=print&amp;tmpl=component" title="Print"
            rel="nofollow">
...
<?php
    ...
    <?php if ($params->get('show_input_mail_to')) {
        ...
        <a href="<?php echo $mosConfig_live_site; ?>/index.php?option=com_mailto&amp;
            tmpl=component&amp;link=<?php $url = JFactory::getURI();
...
?>
        <a href="<?php echo
         $mosConfig_live_site; ?>/index.php?option=com_realestatemanager&task=show_rss_categories&Itemid=<?php
          echo $Itemid; ?>">
            <i class="fa fa-rss"></i>
        </a>
    <?php
