    ...
    <?php if ($params->get('show_input_print_pdf')) { ?>
        <a onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,
          menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
           ...
           ?>/index.php?option=com_realestatemanager&amp;task=showCategory&amp;catid=<?php
           echo $catid; ?>&amp;Itemid=<?php echo $Itemid; ?>&amp;limitstart=<?php
           echo $limitstart; ?>&amp;printItem=pdf" title="PDF"  rel="nofollow">
    ...
    <?php if ($params->get('show_input_print_view')) { ?>
        <a onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,
          menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');
           ...
           ?>/index.php?option=com_realestatemanager&amp;task=showCategory&amp;catid=<?php
           echo $catid; ?>&amp;Itemid=<?php echo $Itemid; ?>&amp;limitstart=<?php
           echo $limitstart; ?>&amp;printItem=print&amp;tmpl=component" title="Print"  rel="nofollow">
...
?>
        <a href="<?php echo $mosConfig_live_site;
         ?>/index.php?option=com_realestatemanager&task=show_rss_categories&Itemid=<?php echo $Itemid; ?>">
            <i class="fa fa-rss"></i>
        </a>
    <?php
        } //endif;
